  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Os hackers devem ser julgados pelas suas capacidade de hacking e não por qualquer outro tipo de critérios discriminatórios;</li>
        <li>Pode criar-se arte e beleza através de um computador;</li>
        <li>Os computadores podem mudar a vida para melhor.</li>
      </ul>
      <p>A Cultura Hacker transcendeu e vai para muito além da semântica. Não fica restrita apenas ao ambiente da tecnologia ou dos computadores. Posso arriscar que tudo que envolve busca do conhecimento para entender o propósito de algo e depois modificar e/ou melhorar para aplicá-lo, buscando um resultado melhor, seja com perspectivas pessoais ou coletivas é um hack, portanto quem o faz é um hacker.</p>

      Trecho retirado de <a href='https://www.foxlab.com.br/a-cultura-hacker/'>https://www.foxlab.com.br/a-cultura-hacker/</a>
    </div>
  );
};
